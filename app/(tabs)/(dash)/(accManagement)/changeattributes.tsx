        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
                ...
                <View style={styles.formContainer}>
                    {/* Required Fields */}
                    <Text style={styles.smallerText}>Preencha os parâmetros da Password e Confirmação da mesma para alterar os atributos </Text>
                    ...
                    <Text style={styles.smallerText}>Preencha os campos com os valores a alterar</Text>
